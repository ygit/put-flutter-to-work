...
public class FlutterActivityLaunchConfigsTest {
    ...
    /* package */ static final String DEFAULT_BACKGROUND_MODE = io.flutter.embedding.android.FlutterActivityLaunchConfigs.BackgroundMode.opaque.name();
    ...
    private FlutterActivityLaunchConfigsTest() {}
}
