...
import com.example.newsfeed_android.FlutterSplashViewTest;
...
/* package */ class FlutterActivityAndFragmentDelegateTest implements ExclusiveAppComponent<Activity> {
    private static final String TAG = "FlutterActivityAndFragmentDelegateTest";
    private static final String FRAMEWORK_RESTORATION_BUNDLE_KEY = "framework";
    private static final String PLUGINS_RESTORATION_BUNDLE_KEY = "plugins";
    private static final int FLUTTER_SPLASH_VIEW_FALLBACK_ID = 486947586;

    /** Factory to obtain a FlutterActivityAndFragmentDelegateTest instance. */
    public interface DelegateFactory {
        com.example.newsfeed_android.FlutterActivityAndFragmentDelegateTest createDelegate(com.example.newsfeed_android.FlutterActivityAndFragmentDelegateTest.Host host);
    }

    // The FlutterActivity or FlutterFragment that is delegating most of its calls
    // to this FlutterActivityAndFragmentDelegateTest.
    @NonNull private com.example.newsfeed_android.FlutterActivityAndFragmentDelegateTest.Host host;
    ...
    FlutterActivityAndFragmentDelegateTest(@NonNull com.example.newsfeed_android.FlutterActivityAndFragmentDelegateTest.Host host) {
        this.host = host;
        this.isFirstFrameRendered = false;
    }

    /**
     * Disconnects this {@code FlutterActivityAndFragmentDelegateTest} from its host {@code Activity} or
     * {@code Fragment}.
     *
     * <p>No further method invocations may occur on this {@code FlutterActivityAndFragmentDelegateTest}
    ...
    /**
     * Whether or not this {@code FlutterActivityAndFragmentDelegateTest} is attached to a {@code
     * FlutterEngine}.
     */
     ...
     *       com.example.newsfeed_android.FlutterActivityAndFragmentDelegateTest.Host#configureFlutterEngine(FlutterEngine)}.
     * </ol>
     */
    ...
    public @NonNull Activity getAppComponent() {
        ...
        if (activity == null) {
            throw new AssertionError(
                    "FlutterActivityAndFragmentDelegateTest's getAppComponent should only "
     ...
     * io.flutter.embedding.engine.FlutterEngine} via {@link com.example.newsfeed_android.FlutterActivityAndFragmentDelegateTest.Host#provideFlutterEngine(Context)}.
     *
    ...
    View onCreateView(
        ...
        if (splashScreen != null) {
            ...
            FlutterSplashViewTest FlutterSplashViewTest = new FlutterSplashViewTest(host.getContext());
            FlutterSplashViewTest.setId(ViewUtils.generateViewId(FLUTTER_SPLASH_VIEW_FALLBACK_ID));
            FlutterSplashViewTest.displayFlutterViewWithSplash(flutterView, splashScreen);

            return FlutterSplashViewTest;
        }
     ...
     *       com.example.newsfeed_android.FlutterActivityAndFragmentDelegateTest.Host#shouldDestroyEngineWithHost()} ()} returns true.
     * </ol>
     */
    void onDetach() {
        Log.v(TAG, "onDetach()");
    ...
    private void ensureAlive() {
        if (host == null) {
            throw new IllegalStateException(
                    "Cannot execute method on a destroyed FlutterActivityAndFragmentDelegateTest.");
        }
    }

    /**
     * The {@link io.flutter.embedding.android.FlutterActivity} or {@link FlutterFragment} that owns this {@code
