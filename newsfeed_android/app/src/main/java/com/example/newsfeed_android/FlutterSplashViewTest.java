 ...
 * first frame.
 */
/* package */ final class FlutterSplashViewTest extends FrameLayout {
    private static String TAG = "FlutterSplashViewTest";
    ...
    public FlutterSplashViewTest(@NonNull Context context) {
        this(context, null, 0);
    }

    public FlutterSplashViewTest(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FlutterSplashViewTest(
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        com.example.newsfeed_android.FlutterSplashViewTest.SavedState savedState = new com.example.newsfeed_android.FlutterSplashViewTest.SavedState(superState);
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (!(state instanceof com.example.newsfeed_android.FlutterSplashViewTest.SavedState)) {
            super.onRestoreInstanceState(state);
            return;
        }
        com.example.newsfeed_android.FlutterSplashViewTest.SavedState savedState = (com.example.newsfeed_android.FlutterSplashViewTest.SavedState) state;
     ...
     *
     * <p>If no {@code splashScreen} is provided, this {@code FlutterSplashViewTest} displays the given
    ...
    public static class SavedState extends BaseSavedState {
        public static Creator<com.example.newsfeed_android.FlutterSplashViewTest.SavedState> CREATOR =
                new Creator<com.example.newsfeed_android.FlutterSplashViewTest.SavedState>() {
                    @Override
                    public com.example.newsfeed_android.FlutterSplashViewTest.SavedState createFromParcel(Parcel source) {
                        return new com.example.newsfeed_android.FlutterSplashViewTest.SavedState(source);
                    }

                    @Override
                    public com.example.newsfeed_android.FlutterSplashViewTest.SavedState[] newArray(int size) {
                        return new com.example.newsfeed_android.FlutterSplashViewTest.SavedState[size];
                    }
                };
